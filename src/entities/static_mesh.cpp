...
void StaticMesh::onCreate(Scene* scene)
{
    ...
    static std::map<std::string, LitSettings> materials = {
        ...
        { "Plant1", LitSettings(glm::vec3(1.f), 0.2f, 50.f, 0.f, 0.f, 0.f, &g_res.textures->plant1, true, false, 0.5f) },
        { "Plant2", LitSettings(glm::vec3(1.f), 0.2f, 50.f, 0.f, 0.f, 0.f, &g_res.textures->plant2, true, false, 0.5f) },
