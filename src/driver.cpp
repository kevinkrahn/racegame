...
void Driver::aiUpgrades(RandomSeries& series)
{
    ...
    std::vector<UpgradeChoice> upgradeChoices = {
        ...
        { ENGINE, 16 + ai.drivingSkill * 2 + ai.awareness, 1 },
        { ENGINE, 15 + ai.drivingSkill * 2 + ai.awareness, 2 },
        { ENGINE, 14 + ai.drivingSkill, 3 },
        { ENGINE, 13 + ai.drivingSkill, 4 },
        { ENGINE, 12 + ai.drivingSkill, MAX_UPGRADE },
        { TIRES, 15 + ai.drivingSkill * 2 + ai.awareness * 2, 1 },
        { TIRES, 14 + ai.drivingSkill * 2 + ai.awareness * 2, 2 },
        { TIRES, 13 + ai.drivingSkill * 2 + ai.awareness, 3 },
