...
public:
    ...
    QuadRenderable(Texture* texture, glm::vec2 p1, f32 width, f32 height,
            glm::vec3 color=glm::vec3(1.0), f32 alpha=1.f, bool blurBackground=false, bool mirror=false)
    ...
    QuadRenderable(Texture* texture, glm::vec2 p1, f32 width, f32 height,
            glm::vec2 t1, glm::vec2 t2, glm::vec3 color=glm::vec3(1.0), f32 alpha=1.f)
        : tex(texture), color(glm::vec4(color, alpha))
    {
        glm::vec2 p2 = p1 + glm::vec2(width, height);
        points[0] = { p1, t1 };
...
public:
    Quad(Texture* texture, glm::vec2 p1, glm::vec2 p2, glm::vec2 t1=glm::vec2(0), glm::vec2 t2=glm::vec2(1),
            glm::vec4 color=glm::vec4(1.0), f32 alpha=1.f) : tex(texture), color(color), alpha(alpha)
    {
        points[0] = { p1, t1 };
        points[1] = { { p2.x, p1.y }, { t2.x, t1.y } };
        points[2] = { { p1.x, p2.y }, { t1.x, t2.y } };
    ...
    Quad(Texture* texture, glm::vec2 p1, f32 width, f32 height,
            glm::vec4 color=glm::vec4(1.0), f32 alpha=1.f, bool mirror=false)
    ...
    Quad(Texture* texture, glm::vec2 p1, f32 width, f32 height,
            glm::vec2 t1, glm::vec2 t2, glm::vec4 color=glm::vec4(1.0), f32 alpha=1.f)
        : tex(texture), color(color), alpha(alpha)
    {
        glm::vec2 p2 = p1 + glm::vec2(width, height);
        points[0] = { p1, t1 };
